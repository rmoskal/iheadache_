...
@Component
public class NotifyUserRegistration implements ApplicationListener <HealthcareUserAdded>{
	...
	public void onApplicationEvent(HealthcareUserAdded event) {
		...
		emailService.sendMessage("/notify_mgt.vm", "Health care provider registered", sendTo,model);
